...
public class Resultatbolk extends JPanel
{
	...
	public void oppdater()
	{
		...
		if (boligen.getBildefilnavn() != null && !boligen.getBildefilnavn().isEmpty())
		{
			try
			{
				final BufferedImage mittBilde1 = ImageIO.read(new File("bilder" + File.separator + boligen.getBildefilnavn()));
			...
			{
				// tom catch fordi hvis bildet ikke funker saa staar det bare "mangler bilde"
			}
		}
